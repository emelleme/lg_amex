<!-- App Container (1025 x 576) -->
		<div>
			...
			<section>
			<p style="padding: 98px 0 0 131px;"><a class="backbtn" href="#" onClick="window.history.back();return false">Back</a></p>
			</section>


			<section style="padding: 18px 0 0 131px;">
			
			<p><img alt="Terms and Conditions" src="$TermsCopy.AbsoluteURL" /></p>
		...
		<div class="navbar navbar-fixed-bottom">
			...
			<ul>
				<li><a class="navbtn" data-page="tipstrends" href="tipstrends.html">On the Runway</a>
