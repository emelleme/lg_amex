<div id="cardsMain">
	...
	<section id="cards-content-new" class="row">
		...
		<div id="shopsmall-agnostic">
			<img src="{$BaseHref}themes/v1/images/shopsmall-ny-bigimage.jpg" style="position: absolute; left: 0; top: 0; width: 245px; height: 328px;" alt="Shop Small" />
			<div style="position: absolute; left: 255px; top: 0;">
				<img src="{$BaseHref}themes/v1/images/shopsmall-ny-smallimages.jpg" alt="Shop Small" />
				...
				<p class="ss-two">Find small businesses near<br>
				you that are recovering<br>
				from Hurricane Sandy:</p>
			
				<p class="ss-three"><span class="gray">Z100.com/shopsmall</span></p>
				
				<img src="{$BaseHref}themes/v1/images/shopsmall-ny-state.png" alt="Shop Small" style="position: absolute; right: 25px; top: 175px;"/>
				
				<p class="termsconditions" style="float: right; margin: 102px -99px 0 0;"><a class="termsbtnblk" href="terms.html">Terms &amp; Conditions</a></p>
			</div>
		</div>
