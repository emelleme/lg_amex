	...
	<section id="cards-content-new" class="row">
		...
		<div id="shopsmall-agnostic">
			...
			<div style="position: absolute; left: 255px; top: 0;">
				...
				<p class="ss-three"><span class="gray">q102.com/shopsmall</span></p>
				
				<img src="{$BaseHref}themes/v1/images/shopsmall-pa-state.png" alt="Shop Small" style="position: absolute; right: 25px; top: 175px;"/>
