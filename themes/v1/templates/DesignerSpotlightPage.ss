...
<% require javascript(themes/v1/javascript/gallery2.js) %>
		...
		<div id="wrapper" class="container">
			...
			<section  style="padding-left:128px;" id="header-new" class="row">
				<div id="header-title" class="span5">
					<h1 style="margin-bottom: -9px;"><img src="themes/v1/images/bazaar-logo.png" alt="Bazaar"></h1>
			...
			<section id="gallery-content-new" class="row">
				<div id="showcase-container">
					<div class="gallery-arrow-l arrows" id="gallery_arrowleft">
					...
					<div class="gallery-arrow-r arrows" id="gallery_arrowright">
					<img src="assets/images/transplaceholder.png" alt="blank" width="30" height="60" />
					</div>
