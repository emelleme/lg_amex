...
Main.tracker=function(a){a.title?alert(a.title):a.title=Main.activeTitle;var b=document.getElementById("pluginObjectNetwork"),b=document.getElementById("pluginObjectNNavi").GetDUID(b.GetHWaddr());a.deviceid=b;$.post("http://sdev.amxp.cc/tipstrends/track/",a).done(function(a){alert("Tracker: "+a)}).fail(function(){alert("error")})};
